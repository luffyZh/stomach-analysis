  ...
  <div>
    <div class="header-top">
      ...
      <div>
        <a-button  @click="goHome">
          ...
          <a-button  @click="goStep2">
          上一页
        </a-button>
        <a-button @click="goStep4">
          下一页
        </a-button>
      </div>
    </div>
    <div class="content-wrap">
      ...
      <div class="right-wrap">
        ...
        <div class="pic-wrap">
          <div class="pic-item" @click="selPic(item)" :class="{active:item.id===activeIndex}" v-for="(item,index) in picArr" :key="index">
            <div class="pic-img">
              <img :src="item.imgSrc">
            </div>
        ...
        <div class="sel-wrap">
          <div class="sel-item">
            ...
            <div>
               <a-select placeholder="请选择" style="width: 120px" @change="handleChange">
                  <a-select-option value="diagnosis1">
                    胃溃疡
                  </a-select-option>
                  <a-select-option value="diagnosis2">
                    胃息肉
                  </a-select-option>
          ...
          <div class="sel-item">
            <div>可能具有的临床症状：</div>
            <div>
               <a-select placeholder="请选择" style="width: 220px" @change="handleChange1">
          ...
          <div class="sel-item">
            <div>位置定位：</div>
            <div>
               <a-select placeholder="请选择" style="width: 120px" @change="handleChange2">
                  <a-select-option value="position1">
                    食管下段
                  </a-select-option>
                  <a-select-option value="position2">
                    胃窦
                  </a-select-option>
                  <a-select-option value="position3">
                    胃底
                  </a-select-option>
                  <a-select-option value="position4">
                    胃角
                  </a-select-option>
            </a-select>
            </div>
...
import u33 from '@/assets/u33.png'
